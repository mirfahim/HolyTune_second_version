...
class BuildBodyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        "downloads count = " + downloadsModel.downloadsList.length.toString());
    return Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            Text(
                                widget.object.artist[0].toUpperCase() +
                                    widget.object.artist.substring(1),
                                style: TextStyles.caption(context)
                                //.copyWith(color: MyColors.grey_60),
                                ),
                            Spacer(),
